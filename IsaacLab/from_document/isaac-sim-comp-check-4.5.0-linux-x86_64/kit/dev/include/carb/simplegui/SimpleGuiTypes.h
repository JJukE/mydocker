...
struct ContextDesc
{
    ...
    windowing::Window* window = nullptr; //!< The Window to use.
    input::Keyboard* keyboard = nullptr; //!< The Keyboard to listen for events. Can be nullptr.
    input::Mouse* mouse = nullptr; //!< The Mouse to listen for events. Can be nullptr.
    input::Gamepad* gamepad = nullptr; //!< The Gamepad to listen for events. Can be nullptr.
};
CARB_ASSERT_INTEROP_SAFE(ContextDesc);
