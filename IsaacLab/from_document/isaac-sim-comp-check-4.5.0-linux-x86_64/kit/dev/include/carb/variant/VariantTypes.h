...
constexpr RString eIObject{ carb::eRString::RS_IObject }; //!< Represents \c IObject
//! @}
 ...
 *   - \ref carb::IObject* / \ref carb::ObjectPtr
 *     * Comparable only with other IObject types, by pointer value.
 *     * Hashes based on the pointer value.
 *     * Variants containing this type always hold a reference.
 *     * \warning Type information for the underlying child class of IObject is not known. It is up to the caller to
 *       provide type safety.
 *
