...
struct Translator<carb::detail::RStringTraits<Uncased, Base>, void>
{
    ...
    static_assert(std::is_trivially_copyable<RStringType>::value, "");
...
struct Translator<typename carb::ObjectPtr<T>,
                  typename std::enable_if_t<cpp::conjunction<cpp::negation<IsCVOrNot<T*, VariantMap*>>,
                                                             cpp::negation<IsCVOrNot<T*, VariantArray*>>>::value>>
{
...
template <class T>
struct Translator<T,
                  typename std::enable_if_t<cpp::conjunction<std::is_convertible<std::remove_cv_t<T>, IObject*>,
                                                             cpp::negation<IsCVOrNot<T, VariantMap*>>,
                                                             cpp::negation<IsCVOrNot<T, VariantArray*>>>::value>>
{
    RString type() const noexcept
    {
