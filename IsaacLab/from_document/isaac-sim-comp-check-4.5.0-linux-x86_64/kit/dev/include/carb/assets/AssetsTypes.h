...
struct LoaderDesc
{
    ...
    CreateLoadParametersFn createLoadParameters = nullptr; //!< @see CreateLoadParametersFn
    DestroyLoadParametersFn destroyLoadParameters = nullptr; //!< @see DestroyLoadParametersFn
    HashLoadParametersFn hashLoadParameters = nullptr; //!< @see HashLoadParametersFn
    LoadParametersEqualsFn loadParametersEquals = nullptr; //!< @see LoadParametersEqualsFn
    HashAssetFn hashAsset = nullptr; //!< @see HashAssetFn
    CreateContextFn createContext = nullptr; //!< @see CreateContextFn
    DestroyContextFn destroyContext = nullptr; //!< @see DestroyContextFn
    CreateDependenciesFn createDependencies = nullptr; //!< @see CreateDependenciesFn
    DestroyDependenciesFn destroyDependencies = nullptr; //!< @see DestroyDependenciesFn
    OnDependencyChangedFn onDependencyChanged = nullptr; //!< @see OnDependencyChangedFn
};
CARB_ASSERT_INTEROP_SAFE(LoaderDesc);
