...
//! \file
//! \brief *carb.windowing* interface definitions.
#pragma once
...
struct Window;
//! Opaque type representing a cursor.
struct Cursor;
//! Opaque type representing a monitor.
struct Monitor;
...
{
    eUnknown, //!< Unknown placeholder.
    eConnected, //!< Monitor was connected.
    eDisconnected //!< Monitor was disconnected.
};
...
//! \defgroup window_hints Window hints
//! @{
typedef uint32_t WindowHints; //!< Type of window hints bitfield
constexpr WindowHints kWindowHintNone = 0; //!< No hint.
constexpr WindowHints kWindowHintNoResize = 1 << 0; //!< The window does not allow resizing.
constexpr WindowHints kWindowHintNoDecoration = 1 << 1; //!< The window should have no decoration.
constexpr WindowHints kWindowHintNoAutoIconify = 1 << 2; //!< The window should not automatically iconify.
constexpr WindowHints kWindowHintNoFocusOnShow = 1 << 3; //!< The window should not focus on show.
constexpr WindowHints kWindowHintScaleToMonitor = 1 << 4; //!< The window should scale to monitor.
constexpr WindowHints kWindowHintFloating = 1 << 5; //!< The window should be floating.
constexpr WindowHints kWindowHintMaximized = 1 << 6; //!< The window should be maximized.
//! @}
...
struct IWindowing
{
     ...
     * @param enabled The new value to apply to @p mode.
     */
     ...
     *
     * @param input Physical key input.
     * @returns Translated key based on current keyboard layout, or \ref input::KeyboardInput::eUnknown.
     */
