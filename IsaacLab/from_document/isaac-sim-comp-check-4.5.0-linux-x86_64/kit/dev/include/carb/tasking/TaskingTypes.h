...
/**
 * Historically, the absolute maximum number of fibers that ITasking will create. However, as of Carbonite 171.0,
 * ITasking will create fibers on demand as memory allows.
 */
...
CARB_ASSERT_INTEROP_SAFE(TaskingDesc);
