 ...
 */
inline std::vector<ObjectPtr<ISubscription>> getSubscriptionsToPop(IEventStream* stream)
{
 ...
 * @returns A vector of ISubscription pointers.
 */
inline std::vector<ObjectPtr<ISubscription>> getSubscriptionsToPush(IEventStream* stream)
{
    std::vector<ObjectPtr<ISubscription>> subscriptions;
