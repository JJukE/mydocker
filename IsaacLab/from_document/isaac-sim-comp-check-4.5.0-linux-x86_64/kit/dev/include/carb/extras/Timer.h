...
{
protected:
    carb::chrono::high_resolution_clock::time_point m_startTimePoint, m_stopTimePoint;
...
public:
    ...
    double getPrecision()
    {
        return carb::chrono::high_resolution_clock::period::num /
               (double)carb::chrono::high_resolution_clock::period::den;
    }
    ...
    void start()
    {
        m_startTimePoint = carb::chrono::high_resolution_clock::now();
        m_isRunning = true;
    }
    /**
     * Stops timer.
    ...
    void stop()
    {
        m_stopTimePoint = carb::chrono::high_resolution_clock::now();
        m_isRunning = false;
    }
    ...
    {
        carb::chrono::high_resolution_clock::time_point stopTimePoint;
        if (m_isRunning)
        {
            stopTimePoint = carb::chrono::high_resolution_clock::now();
        }
        else
        {
