...
public:
                                                     ...
                                                     const EnvVariablesMap* envVariables)
    {
        ...
        const auto itemResolver = [&](dictionary::Item* item, uint32_t elementData, void* userData) -> uint32_t {
        ...
        dictionary::walkDictionary(dictInterface, dictionary::WalkerMode::eIncludeRoot, dict, 0u, itemResolver, nullptr,
                                   getChildByIndexMutable);
    }

    using GetItemFullPathFuncPtr = std::string (*)(dictionary::IDictionary* dictInterface,
                                                   const dictionary::Item* item,
                                                   bool includeRoot);
                                                          ...
                                                          void* userData)
    {
        ...
        {
            std::string itemPath = updaterData->getItemFullPathFunc(updaterData->dictInterface, dstItem, true);
