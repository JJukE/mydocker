...
public:
    ...
    void clear(const uint64_t moduleHash) noexcept;
    ...
    const uint64_t _generateUniqueHash() noexcept;
};
...
inline void omni::core::Generated<omni::kit::exec::core::unstable::IExecutionControllerFactory_abi>::clear(
    const uint64_t moduleHash) noexcept
{
...
inline const uint64_t omni::core::Generated<
    omni::kit::exec::core::unstable::IExecutionControllerFactory_abi>::_generateUniqueHash() noexcept
{
