...
//! Returns a per-module boolean reference that is used to indicate whether log channels have been registered
//! yet.
//!
//! @returns A reference to a module specific boolean that is used to note whether log channels have been
//! registered.
