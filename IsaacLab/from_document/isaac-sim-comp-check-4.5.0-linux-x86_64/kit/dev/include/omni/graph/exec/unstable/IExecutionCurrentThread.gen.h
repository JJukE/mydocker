...
public:
    ...
    CARB_NODISCARD omni::graph::exec::unstable::Status executeGraph(
        omni::core::ObjectParam<omni::graph::exec::unstable::IGraph> graph,
        omni::core::ObjectParam<omni::graph::exec::unstable::IExecutionContext> context) noexcept;
    ...
    //!
    //! @thread_safety This method is thread safe.
    CARB_NODISCARD omni::graph::exec::unstable::Status execute(
        omni::graph::exec::unstable::ExecutionTask& task,
        omni::core::ObjectParam<omni::graph::exec::unstable::IExecutor> executor) noexcept;
...
inline omni::graph::exec::unstable::Status omni::core::Generated<omni::graph::exec::unstable::IExecutionCurrentThread_abi>::executeGraph(
    ...
    omni::core::ObjectParam<omni::graph::exec::unstable::IExecutionContext> context) noexcept
{
    return executeGraph_abi(graph.get(), context.get());
}
...
inline omni::graph::exec::unstable::Status omni::core::Generated<omni::graph::exec::unstable::IExecutionCurrentThread_abi>::execute(
    ...
    omni::core::ObjectParam<omni::graph::exec::unstable::IExecutor> executor) noexcept
{
    return execute_abi(&task, executor.get());
}
