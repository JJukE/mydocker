...
private:
    ...
    TextureData* _textureDataFromState(StyleContainer::State state, bool errorMsgs);
    ...
    // Subscription to call _setProgress on main-thread when texture loaded
    carb::events::ISubscriptionPtr m_texturesLoadedSub;
};
