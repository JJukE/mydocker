...
protected:
     ...
     *                          display.  This may also be @ref omni::platforminfo::kModeIndexCurrent
     *                          to retrieve the information for the given display's current mode.
     *                          This call will simply fail if this index is out of range of the
     *                          number of modes supported by the given display, thus it is not
     *                          necessary to call omni::platforminfo::IDisplayInfo::getModeCount()
     *                          to use in a counted loop.
