...
//
/** @file
 *  @brief Helper interface to retrieve bare metal CPU info.
 */
#pragma once
 ...
 *  supported by them.  This is intended to retrieve the bare metal CPU information, not
 *  any that are limited by a container, VM, or OS level resource limitation.
 */
