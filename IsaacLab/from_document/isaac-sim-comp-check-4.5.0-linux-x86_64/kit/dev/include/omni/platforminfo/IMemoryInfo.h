 ...
 *  values retrieved by this interface will reflect the total bare metal RAM available to the
 *  system, not any values that have been limited by OS level user quotas, containers, or VMs.
 */
