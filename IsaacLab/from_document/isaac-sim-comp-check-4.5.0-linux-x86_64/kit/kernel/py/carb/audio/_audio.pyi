...
__all__ = [
    "AUDIO_IMAGE_FLAG_ALPHA_BLEND",
    "AUDIO_IMAGE_FLAG_MULTI_CHANNEL",
    "AUDIO_IMAGE_FLAG_NOISE_COLOR",
    "AUDIO_IMAGE_FLAG_SPLIT_CHANNELS",
    "AUDIO_IMAGE_FLAG_USE_LINES",
    "AudioResult",
    "CONE_ANGLE_OMNI_DIRECTIONAL",
    "CONTEXT_FLAG_BAKING",
    "CONTEXT_FLAG_MANUAL_STOP",
    "CONTEXT_PARAM_ALL",
    "CONTEXT_PARAM_DEFAULT_PLAYBACK_MODE",
    "CONTEXT_PARAM_DOPPLER_LIMIT",
    "CONTEXT_PARAM_DOPPLER_SCALE",
    "CONTEXT_PARAM_LISTENER",
    "CONTEXT_PARAM_MASTER_VOLUME",
    "CONTEXT_PARAM_NON_SPATIAL_FREQUENCY_RATIO",
    "CONTEXT_PARAM_NON_SPATIAL_VOLUME",
    "CONTEXT_PARAM_SPATIAL_FREQUENCY_RATIO",
    "CONTEXT_PARAM_SPATIAL_VOLUME",
    "CONTEXT_PARAM_SPEED_OF_SOUND",
    "CONTEXT_PARAM_VIDEO_LATENCY",
    "CONTEXT_PARAM_VIRTUALIZATION_THRESHOLD",
    "CONTEXT_PARAM_WORLD_UNIT_SCALE",
    "Context",
    "ContextCaps",
    "ContextError",
    "ContextParams",
    "ContextParams2",
    "DATA_FLAG_CALC_PEAKS",
    "DATA_FLAG_SKIP_EVENT_POINTS",
    "DATA_FLAG_SKIP_METADATA",
    "DEFAULT_CHANNEL_COUNT",
    "DEFAULT_FORMAT",
    "DEFAULT_FRAME_RATE",
    "DEFAULT_SPEED_OF_SOUND",
    "DEVICE_FLAG_CONNECTED",
    "DEVICE_FLAG_DEFAULT",
    "DEVICE_FLAG_NOT_OPEN",
    "DEVICE_FLAG_STREAMER",
    "DecoderError",
    "DeviceCaps",
    "DspValuePair",
    "ENTITY_FLAG_ALL",
    "ENTITY_FLAG_CONE",
    "ENTITY_FLAG_FORWARD",
    "ENTITY_FLAG_MAKE_PERP",
    "ENTITY_FLAG_NORMALIZE",
    "ENTITY_FLAG_POSITION",
    "ENTITY_FLAG_ROLLOFF",
    "ENTITY_FLAG_UP",
    "ENTITY_FLAG_VELOCITY",
    "EVENT_POINT_INVALID_FRAME",
    "EVENT_POINT_LOOP_INFINITE",
    "EmitterAttributes",
    "EncoderError",
    "EntityAttributes",
    "EntityCone",
    ...
    "META_DATA_TAG_ALBUM",
    "META_DATA_TAG_ARCHIVAL_LOCATION",
    "META_DATA_TAG_ARTIST",
    "META_DATA_TAG_AUDIO_SOURCE_WEBSITE",
    "META_DATA_TAG_BPM",
    "META_DATA_TAG_CLEAR_ALL_TAGS",
    "META_DATA_TAG_COMMENT",
    "META_DATA_TAG_COMMISSIONED",
    "META_DATA_TAG_COMPOSER",
    "META_DATA_TAG_CONTACT",
    "META_DATA_TAG_COPYRIGHT",
    "META_DATA_TAG_CREATION_DATE",
    "META_DATA_TAG_CROPPED",
    "META_DATA_TAG_DESCRIPTION",
    "META_DATA_TAG_DIMENSIONS",
    "META_DATA_TAG_DISC",
    "META_DATA_TAG_DPI",
    "META_DATA_TAG_EDITOR",
    "META_DATA_TAG_ENCODER",
    "META_DATA_TAG_END_TIME",
    "META_DATA_TAG_ENGINEER",
    "META_DATA_TAG_FILE_NAME",
    "META_DATA_TAG_GENRE",
    "META_DATA_TAG_INITIAL_KEY",
    "META_DATA_TAG_INTERNET_ARTIST_WEBSITE",
    "META_DATA_TAG_INTERNET_COMMERCIAL_INFORMATION_URL",
    "META_DATA_TAG_INTERNET_COPYRIGHT_URL",
    "META_DATA_TAG_INTERNET_RADIO_STATION_NAME",
    "META_DATA_TAG_INTERNET_RADIO_STATION_OWNER",
    "META_DATA_TAG_INTERNET_RADIO_STATION_URL",
    "META_DATA_TAG_ISRC",
    "META_DATA_TAG_KEYWORDS",
    "META_DATA_TAG_LANGUAGE",
    "META_DATA_TAG_LICENSE",
    "META_DATA_TAG_LIGHTNESS",
    "META_DATA_TAG_LOCATION",
    "META_DATA_TAG_MEDIUM",
    "META_DATA_TAG_ORGANIZATION",
    "META_DATA_TAG_ORIGINAL_YEAR",
    "META_DATA_TAG_OWNER",
    "META_DATA_TAG_PALETTE_SETTING",
    "META_DATA_TAG_PAYMENT_URL",
    "META_DATA_TAG_PERFORMER",
    "META_DATA_TAG_PLAYLIST_DELAY",
    "META_DATA_TAG_PUBLISHER",
    "META_DATA_TAG_RECORDING_DATE",
    "META_DATA_TAG_SHARPNESS",
    "META_DATA_TAG_SOURCE_FORM",
    "META_DATA_TAG_SPEED",
    "META_DATA_TAG_START_TIME",
    "META_DATA_TAG_SUBGENRE",
    "META_DATA_TAG_SUBJECT",
    "META_DATA_TAG_TECHNICIAN",
    "META_DATA_TAG_TERMS_OF_USE",
    "META_DATA_TAG_TITLE",
    "META_DATA_TAG_TRACK_NUMBER",
    "META_DATA_TAG_VERSION",
    "META_DATA_TAG_WEBSITE",
    "META_DATA_TAG_WRITER",
    "MIN_CHANNELS",
    "MIN_FRAMERATE",
    "NotAvailable",
    "OUTPUT_FLAG_DEVICE",
    "OutputDesc",
    "PLAYBACK_MODE_DEFAULT_DISTANCE_DELAY",
    "PLAYBACK_MODE_DEFAULT_INTERAURAL_DELAY",
    "PLAYBACK_MODE_DEFAULT_USE_DOPPLER",
    "PLAYBACK_MODE_DEFAULT_USE_FILTERS",
    "PLAYBACK_MODE_DEFAULT_USE_REVERB",
    "PLAYBACK_MODE_DISTANCE_DELAY",
    "PLAYBACK_MODE_FADE_IN",
    "PLAYBACK_MODE_INTERAURAL_DELAY",
    "PLAYBACK_MODE_LISTENER_RELATIVE",
    "PLAYBACK_MODE_MUTED",
    "PLAYBACK_MODE_NO_POSITION_SIMULATION",
    "PLAYBACK_MODE_NO_SPATIAL_LOW_FREQUENCY_EFFECT",
    "PLAYBACK_MODE_PAUSED",
    "PLAYBACK_MODE_SIMULATE_POSITION",
    "PLAYBACK_MODE_SPATIAL",
    "PLAYBACK_MODE_SPATIAL_MIX_LEVEL_MATRIX",
    "PLAYBACK_MODE_STOP_ON_SIMULATION",
    "PLAYBACK_MODE_USE_DOPPLER",
    "PLAYBACK_MODE_USE_FILTERS",
    "PLAYBACK_MODE_USE_REVERB",
    "PeakVolumes",
    "PlaybackContextDesc",
    "ReadOnly",
    "RolloffDesc",
    ...
    "SAVE_FLAG_STRIP_METADATA",
    "SAVE_FLAG_STRIP_PEAKS",
    "SPEAKER_FLAG_BACK_CENTER",
    "SPEAKER_FLAG_BACK_LEFT",
    "SPEAKER_FLAG_BACK_RIGHT",
    "SPEAKER_FLAG_FRONT_CENTER",
    "SPEAKER_FLAG_FRONT_LEFT",
    "SPEAKER_FLAG_FRONT_LEFT_WIDE",
    "SPEAKER_FLAG_FRONT_RIGHT",
    "SPEAKER_FLAG_FRONT_RIGHT_WIDE",
    "SPEAKER_FLAG_LOW_FREQUENCY_EFFECT",
    "SPEAKER_FLAG_SIDE_LEFT",
    "SPEAKER_FLAG_SIDE_RIGHT",
    "SPEAKER_FLAG_TOP_BACK_LEFT",
    "SPEAKER_FLAG_TOP_BACK_RIGHT",
    "SPEAKER_FLAG_TOP_FRONT_LEFT",
    "SPEAKER_FLAG_TOP_FRONT_RIGHT",
    "SPEAKER_FLAG_TOP_LEFT",
    "SPEAKER_FLAG_TOP_RIGHT",
    "SPEAKER_MODE_COUNT",
    "SPEAKER_MODE_DEFAULT",
    "SPEAKER_MODE_FIVE_POINT_ONE",
    "SPEAKER_MODE_FIVE_POINT_ZERO",
    "SPEAKER_MODE_FOUR_POINT_ONE",
    "SPEAKER_MODE_MONO",
    "SPEAKER_MODE_NINE_POINT_ONE",
    "SPEAKER_MODE_NINE_POINT_ONE_POINT_FOUR",
    "SPEAKER_MODE_NINE_POINT_ONE_POINT_SIX",
    "SPEAKER_MODE_QUAD",
    "SPEAKER_MODE_SEVEN_POINT_ONE",
    "SPEAKER_MODE_SEVEN_POINT_ONE_POINT_FOUR",
    "SPEAKER_MODE_SIX_POINT_ONE",
    "SPEAKER_MODE_STEREO",
    "SPEAKER_MODE_THREE_POINT_ZERO",
    "SPEAKER_MODE_TWO_POINT_ONE",
    "SPEAKER_MODE_VALID_BITS",
    "SampleFormat",
    "SoundData",
    "SoundDataError",
    "SoundFormat",
    ...
    "VOICE_PARAM_ALL",
    "VOICE_PARAM_BALANCE",
    "VOICE_PARAM_DOPPLER_SCALE",
    "VOICE_PARAM_EMITTER",
    "VOICE_PARAM_FREQUENCY_RATIO",
    "VOICE_PARAM_MATRIX",
    "VOICE_PARAM_MUTE",
    "VOICE_PARAM_OCCLUSION_FACTOR",
    "VOICE_PARAM_PAUSE",
    "VOICE_PARAM_PLAYBACK_MODE",
    "VOICE_PARAM_PRIORITY",
    "VOICE_PARAM_SPATIAL_MIX_LEVEL",
    "VOICE_PARAM_VOLUME",
    "Voice",
    "VoiceParamBalance",
    "VoiceParamOcclusion",
...
class AudioResult():
    ...
    def value(self) -> int:
        ...
        :type: int
        """
    DEVICE_DISCONNECTED: carb.audio._audio.AudioResult # value = <AudioResult.DEVICE_DISCONNECTED: 1>
    DEVICE_LOST: carb.audio._audio.AudioResult # value = <AudioResult.DEVICE_LOST: 2>
    DEVICE_NOT_OPEN: carb.audio._audio.AudioResult # value = <AudioResult.DEVICE_NOT_OPEN: 3>
    DEVICE_OPEN: carb.audio._audio.AudioResult # value = <AudioResult.DEVICE_OPEN: 4>
    INVALID_FORMAT: carb.audio._audio.AudioResult # value = <AudioResult.INVALID_FORMAT: 12>
    INVALID_PARAMETER: carb.audio._audio.AudioResult # value = <AudioResult.INVALID_PARAMETER: 8>
    IO_ERROR: carb.audio._audio.AudioResult # value = <AudioResult.IO_ERROR: 11>
    NOT_ALLOWED: carb.audio._audio.AudioResult # value = <AudioResult.NOT_ALLOWED: 9>
    NOT_FOUND: carb.audio._audio.AudioResult # value = <AudioResult.NOT_FOUND: 10>
    NOT_SUPPORTED: carb.audio._audio.AudioResult # value = <AudioResult.NOT_SUPPORTED: 14>
    OK: carb.audio._audio.AudioResult # value = <AudioResult.OK: 0>
    OUT_OF_MEMORY: carb.audio._audio.AudioResult # value = <AudioResult.OUT_OF_MEMORY: 7>
    OUT_OF_RANGE: carb.audio._audio.AudioResult # value = <AudioResult.OUT_OF_RANGE: 5>
    TRY_AGAIN: carb.audio._audio.AudioResult # value = <AudioResult.TRY_AGAIN: 6>
    __members__: dict # value = {'OK': <AudioResult.OK: 0>, 'DEVICE_DISCONNECTED': <AudioResult.DEVICE_DISCONNECTED: 1>, 'DEVICE_LOST': <AudioResult.DEVICE_LOST: 2>, 'DEVICE_NOT_OPEN': <AudioResult.DEVICE_NOT_OPEN: 3>, 'DEVICE_OPEN': <AudioResult.DEVICE_OPEN: 4>, 'OUT_OF_RANGE': <AudioResult.OUT_OF_RANGE: 5>, 'TRY_AGAIN': <AudioResult.TRY_AGAIN: 6>, 'OUT_OF_MEMORY': <AudioResult.OUT_OF_MEMORY: 7>, 'INVALID_PARAMETER': <AudioResult.INVALID_PARAMETER: 8>, 'NOT_ALLOWED': <AudioResult.NOT_ALLOWED: 9>, 'NOT_FOUND': <AudioResult.NOT_FOUND: 10>, 'IO_ERROR': <AudioResult.IO_ERROR: 11>, 'INVALID_FORMAT': <AudioResult.INVALID_FORMAT: 12>, 'NOT_SUPPORTED': <AudioResult.NOT_SUPPORTED: 14>}
    pass
class Context():
    """
...
class RolloffType():
    ...
    def value(self) -> int:
        ...
        :type: int
        """
    INVERSE: carb.audio._audio.RolloffType # value = <RolloffType.INVERSE: 0>
    LINEAR: carb.audio._audio.RolloffType # value = <RolloffType.LINEAR: 1>
    LINEAR_SQUARE: carb.audio._audio.RolloffType # value = <RolloffType.LINEAR_SQUARE: 2>
    __members__: dict # value = {'INVERSE': <RolloffType.INVERSE: 0>, 'LINEAR': <RolloffType.LINEAR: 1>, 'LINEAR_SQUARE': <RolloffType.LINEAR_SQUARE: 2>}
    pass
class SampleFormat():
    """
    ...
    def value(self) -> int:
        ...
        :type: int
        """
    COUNT: carb.audio._audio.SampleFormat # value = <SampleFormat.COUNT: 12>
    DEFAULT: carb.audio._audio.SampleFormat # value = <SampleFormat.DEFAULT: 11>
    FLAC: carb.audio._audio.SampleFormat # value = <SampleFormat.FLAC: 7>
    MP3: carb.audio._audio.SampleFormat # value = <SampleFormat.MP3: 9>
    OPUS: carb.audio._audio.SampleFormat # value = <SampleFormat.OPUS: 8>
    PCM16: carb.audio._audio.SampleFormat # value = <SampleFormat.PCM16: 1>
    PCM24: carb.audio._audio.SampleFormat # value = <SampleFormat.PCM24: 2>
    PCM32: carb.audio._audio.SampleFormat # value = <SampleFormat.PCM32: 3>
    PCM8: carb.audio._audio.SampleFormat # value = <SampleFormat.PCM8: 0>
    PCM_COUNT: carb.audio._audio.SampleFormat # value = <SampleFormat.PCM_COUNT: 5>
    PCM_FLOAT: carb.audio._audio.SampleFormat # value = <SampleFormat.PCM_FLOAT: 4>
    RAW: carb.audio._audio.SampleFormat # value = <SampleFormat.RAW: 10>
    VORBIS: carb.audio._audio.SampleFormat # value = <SampleFormat.VORBIS: 6>
    __members__: dict # value = {'PCM8': <SampleFormat.PCM8: 0>, 'PCM16': <SampleFormat.PCM16: 1>, 'PCM24': <SampleFormat.PCM24: 2>, 'PCM32': <SampleFormat.PCM32: 3>, 'PCM_FLOAT': <SampleFormat.PCM_FLOAT: 4>, 'PCM_COUNT': <SampleFormat.PCM_COUNT: 5>, 'VORBIS': <SampleFormat.VORBIS: 6>, 'FLAC': <SampleFormat.FLAC: 7>, 'OPUS': <SampleFormat.OPUS: 8>, 'MP3': <SampleFormat.MP3: 9>, 'RAW': <SampleFormat.RAW: 10>, 'DEFAULT': <SampleFormat.DEFAULT: 11>, 'COUNT': <SampleFormat.COUNT: 12>}
    pass
class SoundData():
    """
    ...
    def set_metadata(self, tag_name: str, tag_value: str) -> bool: 
        ...
        Add a metadata tag to a SoundData object.
                           ...
                           Returns:
                               No return value.
        """
    def set_valid_length(self, length: int, units: UnitType = UnitType.FRAMES) -> None: 
        """
        Set the length of the valid portion of the SoundData object's buffer.
                           ...
                           Returns:
                               The length of the SoundData object's buffer.
        """
    def write_buffer_with_float(self, data: typing.List[float], offset: int = 0, units: UnitType = UnitType.FRAMES) -> None: 
        """
        ...
        """
    def write_buffer_with_int16(self, data: typing.List[int], offset: int = 0, units: UnitType = UnitType.FRAMES) -> None: 
        """
        ...
        Returns:
            ...
            Only sounds that were created empty or from raw PCM data are writable.
        """
    def write_buffer_with_int32(self, data: typing.List[int], offset: int = 0, units: UnitType = UnitType.FRAMES) -> None: 
        """
        ...
        Returns:
            ...
            Only sounds that were created empty or from raw PCM data are writable.
        """
    def write_buffer_with_uint8(self, data: typing.List[int], offset: int = 0, units: UnitType = UnitType.FRAMES) -> None: 
        """
...
class Speaker():
    ...
    def value(self) -> int:
        ...
        :type: int
        """
    BACK_CENTER: carb.audio._audio.Speaker # value = <Speaker.BACK_CENTER: 6>
    BACK_LEFT: carb.audio._audio.Speaker # value = <Speaker.BACK_LEFT: 4>
    BACK_RIGHT: carb.audio._audio.Speaker # value = <Speaker.BACK_RIGHT: 5>
    COUNT: carb.audio._audio.Speaker # value = <Speaker.COUNT: 17>
    FRONT_CENTER: carb.audio._audio.Speaker # value = <Speaker.FRONT_CENTER: 2>
    FRONT_LEFT: carb.audio._audio.Speaker # value = <Speaker.FRONT_LEFT: 0>
    FRONT_LEFT_WIDE: carb.audio._audio.Speaker # value = <Speaker.FRONT_LEFT_WIDE: 13>
    FRONT_RIGHT: carb.audio._audio.Speaker # value = <Speaker.FRONT_RIGHT: 1>
    FRONT_RIGHT_WIDE: carb.audio._audio.Speaker # value = <Speaker.FRONT_RIGHT_WIDE: 14>
    LOW_FREQUENCY_EFFECT: carb.audio._audio.Speaker # value = <Speaker.LOW_FREQUENCY_EFFECT: 3>
    SIDE_LEFT: carb.audio._audio.Speaker # value = <Speaker.SIDE_LEFT: 7>
    SIDE_RIGHT: carb.audio._audio.Speaker # value = <Speaker.SIDE_RIGHT: 8>
    TOP_BACK_LEFT: carb.audio._audio.Speaker # value = <Speaker.TOP_BACK_LEFT: 11>
    TOP_BACK_RIGHT: carb.audio._audio.Speaker # value = <Speaker.TOP_BACK_RIGHT: 12>
    TOP_FRONT_LEFT: carb.audio._audio.Speaker # value = <Speaker.TOP_FRONT_LEFT: 9>
    TOP_FRONT_RIGHT: carb.audio._audio.Speaker # value = <Speaker.TOP_FRONT_RIGHT: 10>
    TOP_LEFT: carb.audio._audio.Speaker # value = <Speaker.TOP_LEFT: 15>
    TOP_RIGHT: carb.audio._audio.Speaker # value = <Speaker.TOP_RIGHT: 16>
    __members__: dict # value = {'FRONT_LEFT': <Speaker.FRONT_LEFT: 0>, 'FRONT_RIGHT': <Speaker.FRONT_RIGHT: 1>, 'FRONT_CENTER': <Speaker.FRONT_CENTER: 2>, 'LOW_FREQUENCY_EFFECT': <Speaker.LOW_FREQUENCY_EFFECT: 3>, 'BACK_LEFT': <Speaker.BACK_LEFT: 4>, 'BACK_RIGHT': <Speaker.BACK_RIGHT: 5>, 'BACK_CENTER': <Speaker.BACK_CENTER: 6>, 'SIDE_LEFT': <Speaker.SIDE_LEFT: 7>, 'SIDE_RIGHT': <Speaker.SIDE_RIGHT: 8>, 'TOP_FRONT_LEFT': <Speaker.TOP_FRONT_LEFT: 9>, 'TOP_FRONT_RIGHT': <Speaker.TOP_FRONT_RIGHT: 10>, 'TOP_BACK_LEFT': <Speaker.TOP_BACK_LEFT: 11>, 'TOP_BACK_RIGHT': <Speaker.TOP_BACK_RIGHT: 12>, 'FRONT_LEFT_WIDE': <Speaker.FRONT_LEFT_WIDE: 13>, 'FRONT_RIGHT_WIDE': <Speaker.FRONT_RIGHT_WIDE: 14>, 'TOP_LEFT': <Speaker.TOP_LEFT: 15>, 'TOP_RIGHT': <Speaker.TOP_RIGHT: 16>, 'COUNT': <Speaker.COUNT: 17>}
    pass
class UnitType():
    """
    ...
    def value(self) -> int:
        ...
        :type: int
        """
    BYTES: carb.audio._audio.UnitType # value = <UnitType.BYTES: 0>
    FRAMES: carb.audio._audio.UnitType # value = <UnitType.FRAMES: 1>
    MICROSECONDS: carb.audio._audio.UnitType # value = <UnitType.MICROSECONDS: 3>
    MILLISECONDS: carb.audio._audio.UnitType # value = <UnitType.MILLISECONDS: 2>
    __members__: dict # value = {'BYTES': <UnitType.BYTES: 0>, 'FRAMES': <UnitType.FRAMES: 1>, 'MILLISECONDS': <UnitType.MILLISECONDS: 2>, 'MICROSECONDS': <UnitType.MICROSECONDS: 3>}
    pass
class Voice():
    """
    ...
    def set_loop_point(self, point: LoopPointDesc) -> bool: 
        ...
        """
    def set_matrix(self, matrix: typing.List[float]) -> None: 
        """
    ...
    def set_priority(self, priority: int) -> None: 
        ...
        Returns:
            None
        """
    def set_rolloff_curve(self, type: RolloffType, near_distance: float, far_distance: float, volume: typing.List[Float2] = [], low_frequency: typing.List[Float2] = [], low_pass_direct: typing.List[Float2] = [], low_pass_reverb: typing.List[Float2] = [], reverb: typing.List[Float2] = []) -> None: 
        """
...
def get_force_on_playback_mode_flags(flags: int) -> int:
    ...
    Retrieves a set of default playback mode flags that will behave as 'force on' behavior.
                       ...
                       Returns:
                            ...
                            voice parameter block's playback mode value - this will lead to unexpected behavior.
    """
AUDIO_IMAGE_FLAG_ALPHA_BLEND = 16
AUDIO_IMAGE_FLAG_MULTI_CHANNEL = 8
AUDIO_IMAGE_FLAG_NOISE_COLOR = 4
AUDIO_IMAGE_FLAG_SPLIT_CHANNELS = 32
AUDIO_IMAGE_FLAG_USE_LINES = 2
CONE_ANGLE_OMNI_DIRECTIONAL = 6.2831854820251465
CONTEXT_FLAG_BAKING = 2
CONTEXT_FLAG_MANUAL_STOP = 4
CONTEXT_PARAM_ALL = 4294967295
CONTEXT_PARAM_DEFAULT_PLAYBACK_MODE = 2048
CONTEXT_PARAM_DOPPLER_LIMIT = 1024
CONTEXT_PARAM_DOPPLER_SCALE = 8
CONTEXT_PARAM_LISTENER = 4
CONTEXT_PARAM_MASTER_VOLUME = 128
CONTEXT_PARAM_NON_SPATIAL_FREQUENCY_RATIO = 64
CONTEXT_PARAM_NON_SPATIAL_VOLUME = 512
CONTEXT_PARAM_SPATIAL_FREQUENCY_RATIO = 32
CONTEXT_PARAM_SPATIAL_VOLUME = 256
CONTEXT_PARAM_SPEED_OF_SOUND = 1
CONTEXT_PARAM_VIDEO_LATENCY = 8192
CONTEXT_PARAM_VIRTUALIZATION_THRESHOLD = 16
CONTEXT_PARAM_WORLD_UNIT_SCALE = 2
DATA_FLAG_CALC_PEAKS = 16777216
DATA_FLAG_SKIP_EVENT_POINTS = 4194304
DATA_FLAG_SKIP_METADATA = 2097152
DEFAULT_CHANNEL_COUNT = 1
DEFAULT_FORMAT = 4
DEFAULT_FRAME_RATE = 48000
DEFAULT_SPEED_OF_SOUND = 340.0
DEVICE_FLAG_CONNECTED = 1
DEVICE_FLAG_DEFAULT = 2
DEVICE_FLAG_NOT_OPEN = 0
DEVICE_FLAG_STREAMER = 4
ENTITY_FLAG_ALL = 63
ENTITY_FLAG_CONE = 16
ENTITY_FLAG_FORWARD = 4
ENTITY_FLAG_MAKE_PERP = 2147483648
ENTITY_FLAG_NORMALIZE = 1073741824
ENTITY_FLAG_POSITION = 1
ENTITY_FLAG_ROLLOFF = 32
ENTITY_FLAG_UP = 8
ENTITY_FLAG_VELOCITY = 2
EVENT_POINT_INVALID_FRAME = 18446744073709551615
EVENT_POINT_LOOP_INFINITE = 18446744073709551615
INSTANCES_UNLIMITED = 0
INVALID_DEVICE_INDEX = 18446744073709551615
INVALID_SPEAKER_NAME = 18446744073709551615
MAX_CHANNELS = 64
MAX_FRAMERATE = 200000
MAX_NAME_LENGTH = 512
MEMORY_LIMIT_THRESHOLD = 2147483648
META_DATA_TAG_ALBUM = 'OriginalTitle'
META_DATA_TAG_ARCHIVAL_LOCATION = 'Archival Location'
META_DATA_TAG_ARTIST = 'Artist'
META_DATA_TAG_AUDIO_SOURCE_WEBSITE = 'AudioSourceWebsite'
META_DATA_TAG_BPM = 'BPM'
META_DATA_TAG_CLEAR_ALL_TAGS = None
META_DATA_TAG_COMMENT = 'Comment'
META_DATA_TAG_COMMISSIONED = 'Commissioned'
META_DATA_TAG_COMPOSER = 'Composer'
META_DATA_TAG_CONTACT = 'Contact'
META_DATA_TAG_COPYRIGHT = 'Copyright'
META_DATA_TAG_CREATION_DATE = 'Date'
META_DATA_TAG_CROPPED = 'Cropped'
META_DATA_TAG_DESCRIPTION = 'Description'
META_DATA_TAG_DIMENSIONS = 'Dimensions'
META_DATA_TAG_DISC = 'Disc'
META_DATA_TAG_DPI = 'Dots Per Inch'
META_DATA_TAG_EDITOR = 'Editor'
META_DATA_TAG_ENCODER = 'Encoder'
META_DATA_TAG_END_TIME = 'EndTime'
META_DATA_TAG_ENGINEER = 'Engineer'
META_DATA_TAG_FILE_NAME = 'FileName'
META_DATA_TAG_GENRE = 'Genre'
META_DATA_TAG_INITIAL_KEY = 'InitialKey'
META_DATA_TAG_INTERNET_ARTIST_WEBSITE = 'ArtistWebsite'
META_DATA_TAG_INTERNET_COMMERCIAL_INFORMATION_URL = 'CommercialInformationUrl'
META_DATA_TAG_INTERNET_COPYRIGHT_URL = 'CopyrightUrl'
META_DATA_TAG_INTERNET_RADIO_STATION_NAME = 'InternetRadioStationName'
META_DATA_TAG_INTERNET_RADIO_STATION_OWNER = 'InternetRadioStationOwner'
META_DATA_TAG_INTERNET_RADIO_STATION_URL = 'InternetRadioStationUrl'
META_DATA_TAG_ISRC = 'ISRC'
META_DATA_TAG_KEYWORDS = 'Keywords'
META_DATA_TAG_LANGUAGE = 'Language'
META_DATA_TAG_LICENSE = 'License'
META_DATA_TAG_LIGHTNESS = 'Lightness'
META_DATA_TAG_LOCATION = 'Location'
META_DATA_TAG_MEDIUM = 'Medium'
META_DATA_TAG_ORGANIZATION = 'Organization'
META_DATA_TAG_ORIGINAL_YEAR = 'OriginalYear'
META_DATA_TAG_OWNER = 'Owner'
META_DATA_TAG_PALETTE_SETTING = 'Palette Setting'
META_DATA_TAG_PAYMENT_URL = 'PaymentUrl'
META_DATA_TAG_PERFORMER = 'OriginalPerformer'
META_DATA_TAG_PLAYLIST_DELAY = 'PlaylistDelay'
META_DATA_TAG_PUBLISHER = 'Publisher'
META_DATA_TAG_RECORDING_DATE = 'RecordingDate'
META_DATA_TAG_SHARPNESS = 'Sharpness'
META_DATA_TAG_SOURCE_FORM = 'Source Form'
META_DATA_TAG_SPEED = 'Speed'
META_DATA_TAG_START_TIME = 'StartTime'
META_DATA_TAG_SUBGENRE = 'SubGenre'
META_DATA_TAG_SUBJECT = 'Subject'
META_DATA_TAG_TECHNICIAN = 'Technician'
META_DATA_TAG_TERMS_OF_USE = 'TermsOfUse'
META_DATA_TAG_TITLE = 'Title'
META_DATA_TAG_TRACK_NUMBER = 'TrackNumber'
META_DATA_TAG_VERSION = 'Version'
META_DATA_TAG_WEBSITE = 'Website'
META_DATA_TAG_WRITER = 'OriginalWriter'
MIN_CHANNELS = 1
MIN_FRAMERATE = 1000
OUTPUT_FLAG_DEVICE = 1
PLAYBACK_MODE_DEFAULT_DISTANCE_DELAY = 536870912
PLAYBACK_MODE_DEFAULT_INTERAURAL_DELAY = 268435456
PLAYBACK_MODE_DEFAULT_USE_DOPPLER = 1073741824
PLAYBACK_MODE_DEFAULT_USE_FILTERS = 67108864
PLAYBACK_MODE_DEFAULT_USE_REVERB = 134217728
PLAYBACK_MODE_DISTANCE_DELAY = 4
PLAYBACK_MODE_FADE_IN = 512
PLAYBACK_MODE_INTERAURAL_DELAY = 8
PLAYBACK_MODE_LISTENER_RELATIVE = 2
PLAYBACK_MODE_MUTED = 128
PLAYBACK_MODE_NO_POSITION_SIMULATION = 2048
PLAYBACK_MODE_NO_SPATIAL_LOW_FREQUENCY_EFFECT = 8192
PLAYBACK_MODE_PAUSED = 256
PLAYBACK_MODE_SIMULATE_POSITION = 1024
PLAYBACK_MODE_SPATIAL = 1
PLAYBACK_MODE_SPATIAL_MIX_LEVEL_MATRIX = 4096
PLAYBACK_MODE_STOP_ON_SIMULATION = 16384
PLAYBACK_MODE_USE_DOPPLER = 16
PLAYBACK_MODE_USE_FILTERS = 64
PLAYBACK_MODE_USE_REVERB = 32
SAVE_FLAG_DEFAULT = 0
SAVE_FLAG_STRIP_EVENT_POINTS = 2
SAVE_FLAG_STRIP_METADATA = 1
SAVE_FLAG_STRIP_PEAKS = 4
SPEAKER_FLAG_BACK_CENTER = 16
SPEAKER_FLAG_BACK_LEFT = 128
SPEAKER_FLAG_BACK_RIGHT = 256
SPEAKER_FLAG_FRONT_CENTER = 4
SPEAKER_FLAG_FRONT_LEFT = 1
SPEAKER_FLAG_FRONT_LEFT_WIDE = 8192
SPEAKER_FLAG_FRONT_RIGHT = 2
SPEAKER_FLAG_FRONT_RIGHT_WIDE = 16384
SPEAKER_FLAG_LOW_FREQUENCY_EFFECT = 8
SPEAKER_FLAG_SIDE_LEFT = 32
SPEAKER_FLAG_SIDE_RIGHT = 64
SPEAKER_FLAG_TOP_BACK_LEFT = 2048
SPEAKER_FLAG_TOP_BACK_RIGHT = 4096
SPEAKER_FLAG_TOP_FRONT_LEFT = 512
SPEAKER_FLAG_TOP_FRONT_RIGHT = 1024
SPEAKER_FLAG_TOP_LEFT = 32768
SPEAKER_FLAG_TOP_RIGHT = 65536
SPEAKER_MODE_COUNT = 7
SPEAKER_MODE_DEFAULT = 0
SPEAKER_MODE_FIVE_POINT_ONE = 63
SPEAKER_MODE_FIVE_POINT_ZERO = 55
SPEAKER_MODE_FOUR_POINT_ONE = 59
SPEAKER_MODE_MONO = 1
SPEAKER_MODE_NINE_POINT_ONE = 25023
SPEAKER_MODE_NINE_POINT_ONE_POINT_FOUR = 32703
SPEAKER_MODE_NINE_POINT_ONE_POINT_SIX = 131007
SPEAKER_MODE_QUAD = 51
SPEAKER_MODE_SEVEN_POINT_ONE = 447
SPEAKER_MODE_SEVEN_POINT_ONE_POINT_FOUR = 8127
SPEAKER_MODE_SIX_POINT_ONE = 463
SPEAKER_MODE_STEREO = 3
SPEAKER_MODE_THREE_POINT_ZERO = 7
SPEAKER_MODE_TWO_POINT_ONE = 11
SPEAKER_MODE_VALID_BITS = 131007
VOICE_PARAM_ALL = 4294967295
VOICE_PARAM_BALANCE = 8
VOICE_PARAM_DOPPLER_SCALE = 256
VOICE_PARAM_EMITTER = 1024
VOICE_PARAM_FREQUENCY_RATIO = 16
VOICE_PARAM_MATRIX = 2048
VOICE_PARAM_MUTE = 4
VOICE_PARAM_OCCLUSION_FACTOR = 512
VOICE_PARAM_PAUSE = 64
VOICE_PARAM_PLAYBACK_MODE = 1
VOICE_PARAM_PRIORITY = 32
VOICE_PARAM_SPATIAL_MIX_LEVEL = 128
VOICE_PARAM_VOLUME = 2
