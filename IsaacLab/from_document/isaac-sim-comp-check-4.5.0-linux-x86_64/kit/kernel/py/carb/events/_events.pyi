...
class AdapterType():
    ...
    def value(self) -> int:
        ...
        :type: int
        """
    DISPATCH: carb.events._events.AdapterType # value = <AdapterType.DISPATCH: 0>
    FULL: carb.events._events.AdapterType # value = <AdapterType.FULL: 2>
    PUSH_PUMP: carb.events._events.AdapterType # value = <AdapterType.PUSH_PUMP: 1>
    __members__: dict # value = {'DISPATCH': <AdapterType.DISPATCH: 0>, 'PUSH_PUMP': <AdapterType.PUSH_PUMP: 1>, 'FULL': <AdapterType.FULL: 2>}
    pass
class IEvent():
    """
    Event.
...
class MappingEntry():
    ...
    def dispatch_name(self) -> str:
        ...
        :type: str
        """
    @dispatch_name.setter
    def dispatch_name(self, arg1: str) -> None:
        pass
    @property
    def push_name(self) -> str:
        ...
        """
    @push_name.setter
    def push_name(self, arg1: str) -> None:
        pass
    @property
    def type(self) -> int:
        """
