...
class Event():
    ...
    """
    def __getitem__(self, key_name: str) -> object: 
        """
...
class IEventDispatcher():
    ...
    def has_observers(self, event_name: str, filter: handle = None) -> bool: 
        ...
        """
    @staticmethod
    def observe_event(*args, **kwargs) -> typing.Any: 
        """
...
class IMessageQueue():
    ...
    def _push(self, event_name: str, payload: handle = None, callback: handle = None) -> None: ...
